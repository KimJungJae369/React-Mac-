...
/*
    ...
    <props 객체란>
    = 컴폰너트를 마치 HTML 태그처럼 사용해 값을 속성 형태로 전달
    = 예를 들어 '부모 컴포넌트'에서 '지식 컴포넌트'의 데이터를 전달
    ...
    ex)
        ...
        - 여러 데이터를 전달하고 싶다면 속성을 여러 개 추가
            ...
            - props는 '부모 컴포넌트'가 '자식 컴포넌트'에게 넘겨주는 모든 데이터가 담신 객체
            - '자식 컴포넌트'는 전달받은 props 객체를 함수의 매개변수롤 받는다
        ...
        [User]
            ...
            [수정]
                ...
                - 잘못된 타입을 전달하면 타입스크립트가 컴파일(사람이 쓰는 언어를 컴퓨터 언어로 바꾸는 번역기 같은) 시점에 오류가 발생
