...
/*
    ...
    ex)
        ...
        2. return <User UserObj={UserObj}/>
        - 'UserObj' 객체를 'UserObj'라는 속성으로 'User 컴포넌트'에 전달한다
    ...
    ex)
        ...
        2. return <User UserObj={UserObj} clickHandler={clickHandler}/>
        - 'clickHandler()'함수를 'clickHandler()'라는 속성으로 User 컴포넌트에 전달
        }
